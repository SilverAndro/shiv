...
import io.github.silverandro.fiwb.internal.UnusedTargetClass;
...
public class FuckItWeBallPlugin implements IMixinConfigPlugin {
	...
	private void applyArbitraryTransforms(ClassNode targetNode, ClassNode mixinNode) throws IllegalAccessException, NoSuchMethodException, InvocationTargetException, InstantiationException, ClassNotFoundException {
		...
		newClass.name = "io/github/silverandro/fiwb/internal/" + name;
		...
		var out = QuiltLoader.getGameDir().resolve(".fiwb/synth");
		out.toFile().mkdirs();
